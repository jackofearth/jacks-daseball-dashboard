  ...
  extractKeyLogic(functionContent, algorithmType) {
    ...
    if (algorithmType === 'traditional') {
      logic.positionAssignments = [
        ...
        { position: '2nd (Elite Hitter)', criteria: 'Highest remaining OPS', weighting: '100% OPS' },
        { position: '3rd (Remaining Talent)', criteria: 'Gets remaining top talent', weighting: '100% OPS' },
        ...
        { position: '6th-9th', criteria: 'Descending OPS', weighting: '100% OPS' }
      ];

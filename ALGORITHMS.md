...
*Last updated: 2025-10-31 (57647ee)*
...
**File:** `src/DraggableBattingOrderMantine.tsx` (lines 650-757)  
...
**File:** `src/DraggableBattingOrderMantine.tsx` (lines 759-915)  
...
*This documentation is automatically updated on each commit. Last algorithm code inspection: 2025-10-31 (57647ee)*

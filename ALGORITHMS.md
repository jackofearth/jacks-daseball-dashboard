...
*Last updated: 2025-10-30 (d64675c)*
...
**File:** `src/DraggableBattingOrderMantine.tsx` (lines 519-626)  
...
**File:** `src/DraggableBattingOrderMantine.tsx` (lines 628-784)  
...
*This documentation is automatically updated on each commit. Last algorithm code inspection: 2025-10-30 (d64675c)*
